...
INSERT INTO notlar VALUES ('Orhan',70.5);
INSERT INTO notlar VALUES ('Ali',80.5);
INSERT INTO notlar VALUES ('Omer',86.5);
INSERT INTO notlar VALUES ('Sumeyye',86.5);
INSERT INTO notlar VALUES ('Adem',86.5);
...
INSERT INTO ogrenciler6 VALUES ('1234567','ferhat','duru',85.5, now());
INSERT INTO ogrenciler6 VALUES ('1234568','Ali','veli',85,now());
...
--Tabloda “tedarikci_id”, “tedarikci_ismi”, “iletisim_isim” field’lari olsun ve
--“tedarikci_id” yi Primary Key yapin.
--“urunler” isminde baska bir tablo olusturun “tedarikci_id” ve 
--“urun_id” field’lari olsun ve
...
DELETE FROM calianlar;   --Eger parent table baska bir child table ile iliskili ise once child table silinmelidir
...
--Adresler tablosundan sehri Antep lan verileri silelim
